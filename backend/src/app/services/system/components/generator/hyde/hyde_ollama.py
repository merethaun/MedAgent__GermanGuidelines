...
class HyDEOllamaGenerator(AbstractHyDEGenerator, variant_name="ollama"):
    ...
    default_parameters: Dict[str, Any] = {**ollama_defaults, **hyde_defaults}

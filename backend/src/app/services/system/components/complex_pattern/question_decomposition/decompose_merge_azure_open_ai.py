...
class DecomposeMergeAzureOpenAIGenerator(MergeComponent, variant_name="azure_open_ai"):
    ...
    default_parameters: Dict[str, Any] = {**azure_defaults, **decompose_merge_defaults}
    ...
    def get_init_parameters(cls) -> Dict[str, Dict[str, Any]]:
        base_decompose_split = deepcopy(MergeComponent.get_init_parameters())

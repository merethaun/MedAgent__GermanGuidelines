...
class DecomposeSplitOllamaGenerator(SplitComponent, variant_name="ollama"):
    ...
    default_parameters: Dict[str, Any] = {**ollama_defaults, **decompose_split_defaults}
    ...
    def get_init_parameters(cls) -> Dict[str, Dict[str, Any]]:
        ...
        merged = {**base_ollama, **base_decompose_split}
        return merged

...
class ChunkOrderProcessor(AbstractPostProcessor, ABC, variant_name="chunk_order"):
    variants: Dict[str, Type['ChunkOrderProcessor']] = {}
    ...
    def __init_subclass__(cls, variant_name: Optional[str] = None, **kwargs):
        ...
        if variant_name:
            ChunkOrderProcessor.variants[variant_name] = cls
